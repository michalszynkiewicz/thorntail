 ...
 * mstodo: merge with the one in the maven plugin?
 * 
 */
public class SimpleArtifactResolvingHelper implements ArtifactResolvingHelper {

    public SimpleArtifactResolvingHelper(ArtifactResolver resolver,
    ...
    public void remoteRepository(ArtifactRepository repo) {
        if (repo instanceof RemoteRepository) {
            this.remoteRepositories.add((RemoteRepository)repo);
        }
    }
